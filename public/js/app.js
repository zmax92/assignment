...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (penItems != null) {
    penItems.map(function (srcElement) {
      // attach event click on all pen icons
      srcElement.addEventListener('click', function (element) {
        // find closest cell
  ...
  if (inputItems != null) {
    inputItems.map(function (srcElement) {
      srcElement.addEventListener('blur', function (element) {
